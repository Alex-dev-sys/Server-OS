...
export const NAV: NavItem[] = [
  ...
  { to: '/vpn', label: 'VPN', icon: Shield, group: 'services' },
  { to: '/storage', label: 'Storage', icon: Archive, group: 'services' },
  { to: '/queue', label: 'Queue', icon: ListTree, group: 'services' },
  { to: '/ci', label: 'CI/CD', icon: GitBranch, group: 'services' },
