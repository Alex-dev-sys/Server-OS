    ...
    <Card className="overflow-hidden">
      ...
      {affected.length === 0 ? (
        <div className="flex items-center gap-3 px-5 py-7 text-[13px] text-fg-muted">
          ...
          All dependencies are operating within nominal thresholds.
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block text-[11px] text-fg-faint">{service.dependsOn.length} upstream dependencies</span>
                </span>
